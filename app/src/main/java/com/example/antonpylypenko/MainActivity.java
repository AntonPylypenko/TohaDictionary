...
*/
    ...
    private String[] gairaigoTranslations = {
            "romantic couple",
            "after service",
            "(teen) idol, pop star",
    ...
    ArrayList<String> gairaigoWordsList = new ArrayList<>(Arrays.asList(gairaigoWords));
    ArrayList<String> gairaigoTranslationsList = new ArrayList<>(Arrays.asList(gairaigoTranslations));

    AutoCompleteTextView myAutoCompleteTextView;
    TextView myTranslationTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTranslationTextView = (TextView) findViewById(R.id.translationText);
        ...
        myChangeButton = (Button) findViewById(R.id.changeButton);

        myAutoCompleteTextView.setAdapter(new ArrayAdapter<>(this,
            android.R.layout.simple_dropdown_item_1line, gairaigoTranslationsList));

        mySearchButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String word = myAutoCompleteTextView.getText().toString();
                myTranslationTextView.setText(gairaigoWordsList.get(gairaigoTranslationsList.indexOf(word)));
            }
        });

        myChangeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                /*
                gairaigoWordsList = new ArrayList<>(Arrays.asList(gairaigoTranslations));
                gairaigoTranslationsList = new ArrayList<>(Arrays.asList(gairaigoWords));
                */
            }
        });
    }
